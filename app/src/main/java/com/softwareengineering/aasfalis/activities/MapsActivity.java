...
public class MapsActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapbox.getInstance(this, "pk.eyJ1IjoiZWRtaXJzdWxqaWMiLCJhIjoiY2p3cWtuMDVqMWI1aDRibGUycDIxeDNudCJ9.wdknEhPMNU-liHtsCopCrA");
    ...
    public void onMapReady(@NonNull MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(new Style.Builder().fromUrl("mapbox://styles/edmirsuljic/cjwql0etg023e1cpkmgrn44ky"),
                style -> {
    ...
    public void onExplanationNeeded(List<String> permissionsToExplain) {
        Toast.makeText(this, "This is an explanation", Toast.LENGTH_LONG).show();
    }
